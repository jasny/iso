...
class Mime
{
    ...
    protected static $list = [
        ...
        ".crl" => ["application/pkcs-crl", "application/pkix-crl", "application/pkix-cert", "application/x-x509-ca-cert", "application/x-x509-user-cert"],
        ".csh" => ["application/x-csh", "text/x-script.csh"],
        ".css" => ["application/x-pointplus", "text/css"],
        ".cxx" => "text/plain",
        ".dcr" => "application/x-director",
        ".deepv" => "application/x-deepv",
        ".def" => ["text/plain", "application/x-x509-ca-cert"],
        ".dif" => "video/x-dv",
     ...
     *
     * @param string|array $inputMime mime
     * @return string
     */
    public static function getExtension($inputMime)
    {
        ...
        foreach (static::$list as $ext => $arrayMime) {
            if ((is_array($arrayMime) && in_array($inputMime, $arrayMime)) || ($inputMime === $arrayMime)) array_push($result, $ext);
        }
    ...
    {
        return isset(static::$list[$ext]) ? static::$list[$ext] : null;
    }
}
